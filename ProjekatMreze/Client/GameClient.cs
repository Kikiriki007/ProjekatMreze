...
namespace invaders.Client
{
    public class GameClient
    {
        ...
        public event Action<string> OnLog;                  //clankrer ask
        ...
        public bool Connect(string serverIp, string playerName)//pocetak uigre
        {
            ...
            try
            {
                ...
                receiveThread = new Thread(() => ReceiveLoop(buffer)) { IsBackground = true };//moras imati thread za receivoanje
                receiveThread.Start();
        ...
        private void ReceiveLoop(byte[] buffer)//podaci od servera
        {
